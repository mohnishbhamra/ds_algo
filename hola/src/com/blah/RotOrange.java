...
public class RotOrange {
    ...
    static int rotOranges(int arr[][]) {
        ...
        // Process the grid while there are rotten oranges in the QueueStudy
        while (!Q.isEmpty()) {
            ...
            while (!isDelim(Q.peek())) {
                ...
                if (isValid(temp.x + 1, temp.y) && arr[temp.x + 1][temp.y] == 1) {
                    ...
                    // push the adjacent orange to QueueStudy
                    temp.x++;
                ...
                if (isValid(temp.x - 1, temp.y) && arr[temp.x - 1][temp.y] == 1) {
                    ...
                    arr[temp.x - 1][temp.y] = 2;
                    temp.x--;
                    Q.add(new Ele(temp.x, temp.y)); // push this cell to QueueStudy
                    temp.x++;
                }
            ...
            // If QueueStudy was empty than no rotten oranges left to process so exit
        }
