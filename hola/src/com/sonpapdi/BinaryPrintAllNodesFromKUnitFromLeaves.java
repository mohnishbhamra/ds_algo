...
public class BinaryPrintAllNodesFromKUnitFromLeaves {
    Node root;
    ...
    public static void main(String args[]) {
        BinaryPrintAllNodesFromKUnitFromLeaves tree = new BinaryPrintAllNodesFromKUnitFromLeaves();
...
/*    private int printKDistantfromLeaf2(Node root,int k) {
        if(root==null){
            return 0;
        }
        int i=0;
        int lunit = printKDistantfromLeaf2(root.left,k);
        int runit = printKDistantfromLeaf2(root.right,k);
        if(lunit==k||runit==k){
