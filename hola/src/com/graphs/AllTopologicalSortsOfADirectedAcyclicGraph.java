...
//Java program to print all topolgical sorts of a graph
    ...
    public AllTopologicalSortsOfADirectedAcyclicGraph(int V) {
    ...
    public static void main(String[] args) {
        ...
        AllTopologicalSortsOfADirectedAcyclicGraph graph = new AllTopologicalSortsOfADirectedAcyclicGraph(6);
        graph.addEdge(5, 2);
        graph.addEdge(5, 0);
        graph.addEdge(4, 0);
        graph.addEdge(4, 1);
